    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          child:
                    ...
                    children: [
                      Container(
                        ...
                        child: ListTile(
                          ...
                          title: Text(books[index]['name'] ?? 'No Name'),
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'Taken Date: ${books[index]['takenDate'] ?? 'Unknown'}'),
                            ],
                          ),
                          trailing: Text(books[index]['returnDate'] ?? 'Unknown'),
            ...
            //         child: ListTile(
            //       leading: Icon(Icons.book),
            //       title: Text(books[index]['name'].toString()),
            //       trailing: Text("jjkkjsf"),
            //     ));
            //   },
            // ))
          ]),
